...
const LinkButton = ({ href, icon: Icon, bgColor, textColor, text }) => (
    <a 
        ...
        className={`
            ...
            /* ADD DARK MODE BACKGROUND AND TEXT COLOR FOR BUTTONS */
...
function AboutPage() {
    ...
    // Adjusted color schemes to look good against a dark background 
    ...
    const allSocialLinks = [
        ...
        { 
            href: "https://www.tiktok.com/@upendra_uddimantha", 
            icon: Music2, 
            bgColor: "bg-gray-100", 
    ...
    return (
        /* Removed bg-gray-50, added dark:text-gray-100 for overall text color */
